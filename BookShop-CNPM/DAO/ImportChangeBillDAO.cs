...
namespace BookShop_CNPM.DAO
{
    public class ImportChangeBillDAO : IDAO<ImportChangeBillDTO>
    {
        ...
        public bool createImportChangeBillDetail(ImportChangeBillDetailDTO data, string madon)
        {
            string sql = $@"INSERT INTO chitietdoinhaphang (maPhieuDoiNhapHang, maSachCanDoi, donGiaSachCanDoi, maSachMuonDoi, donGiaSachMuonDoi, soLuong) 
                            VALUES (@maPhieuDoiNhapHang, @maSachCanDoi, @donGiaSachCanDoi, @maSachMuonDoi, @donGiaSachMuonDoi, @soLuong);";
            ...
            if (rowChanged > 0)
            {
                 ...
                 ImportBillBUS.Instance.createBookAmount(madon, data.SachCanDoi.ToString(), data.soLuong);
            }
