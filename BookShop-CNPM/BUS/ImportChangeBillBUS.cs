...
namespace BookShop_CNPM.BUS
{
    public class ImportChangeBillBUS : IBUS<ImportChangeBillDTO>
    {
        ...
        public bool createImportChangeBillDetail(ImportChangeBillDetailDTO customerChangeBillDetail, string madon)
        {
            return ImportChangeBillDAO.Instance.createImportChangeBillDetail(customerChangeBillDetail,madon);
        }
    }
}
