...
namespace BookShop_CNPM.BUS
{
    public class ImportRefundBillBUS : IBUS<ImportRefundBillDTO>
    {
        ...
        public bool createImportRefundBillDetail(ImportRefundBillDetailDTO importRefundBillDetail, string madon)
        {
            return ImportRefundBillDAO.Instance.createImportRefundBillDetail(importRefundBillDetail,madon);
        }
