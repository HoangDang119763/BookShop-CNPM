...
namespace BookShop_CNPM.BUS
{
    public class CustomerChangeBillBUS : IBUS<CustomerChangeBillDTO>
    {
        ...
        {
            return CustomerChangeBillDAO.Instance.getChangeQuantityByBookId(bookId);
		}

		public decimal getChangeRevenueByBookId(string bookId)
        {
			return CustomerChangeBillDAO.Instance.getChangeRevenueByBookId(bookId);
		}
        ...
        public bool createCustomerChangeBillDetail(CustomerChangeBillDetailDTO customerChangeBillDetail,string madon)
        {
            return CustomerChangeBillDAO.Instance.createCustomerChangeBillDetail(customerChangeBillDetail,madon);
        }
    }
}