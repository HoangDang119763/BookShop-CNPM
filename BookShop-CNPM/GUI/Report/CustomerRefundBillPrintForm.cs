...
namespace BookShop_CNPM.GUI.Report
{
    public partial class CustomerRefundBillPrintForm : Form
    {
        ...
        {
            Console.WriteLine(maDonTraHang);
            InitializeComponent();
        ...
        {
            List<CustomerRefundBillDetailDTO> customerBillDetailList = CustomerRefundBillBUS.Instance.getCustomerRefundBillDetailList(
            ...
            foreach (CustomerRefundBillDetailDTO customerBillDetail in customerBillDetailList)
            {
            ...
            Microsoft.Reporting.WinForms.ReportParameter[] p = new Microsoft.Reporting.WinForms.ReportParameter[]
            {
                ...
                new Microsoft.Reporting.WinForms.ReportParameter("pTotalPrice", customerRefundBill.TongTien.ToString()),
